<h1>Origins and History of Whisky</h1>

<img src="./image/aboutimg.jpg" class="imgaboutleft"  style=" float: right;
	width: 250px;
	height: 250px;
...
<div class="txtaboutleft">
<img src="./image/aboutqwqrmkl.jpg" class="imgaboutright" style="float: left;
	width: 250px;
	height: 250px;
	margin: 0px 10px 10px 0;
	padding: 10px;" />
...
<div class="txtaboutright">
<img src="./image/images (2).jpg" class="imgaboutleft" style="float: left;
	width: 250px;
	height: 250px;
	margin: 0px 10px 10px 0;
	padding: 10px;"/>
...
<div class="txtaboutleft">
<p><img src="./image/images (1).jpg" class="imgaboutright" style="float: right;
	width: 250px;
	height: 250px;
	margin: 0px 10px 10px 0;
	padding: 10px;">
